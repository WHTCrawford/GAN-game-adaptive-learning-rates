...
\textbf{number\_of\_steps} we generate \textbf{batch\_size} real samples
and \textbf{batch\_size} fake samples and used these to carry out
simulateneous minibatch gradient descent. In our experiments we iterated
this process many times in order to collect over 10,000 parameter
combinations in total, for simplicity we display the code for a single
group of the sixteen parameter combinations.
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{n}{gamma\PYZus{}vec} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{uniform}\PY{p}{(}\PY{l+m+mf}{0.0000001}\PY{p}{,}\PY{l+m+mf}{0.1}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
        ...
        \PY{n}{number\PYZus{}of\PYZus{}steps} \PY{o}{=} \PY{l+m+mi}{100000}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{hidden\PYZus{}layer\PYZus{}size\PYZus{}d} \PY{o}{=} \PY{l+m+mi}{6}
        ...
        \PY{n}{weight\PYZus{}d\PYZus{}1} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{random\PYZus{}uniform}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{hidden\PYZus{}layer\PYZus{}size\PYZus{}d}\PY{p}{]}\PY{p}{,} 
                                    \PY{n}{minval}\PY{o}{=}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{maxval}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{float32}\PY{p}{)}\PY{p}{)}
        ...
        \PY{n}{weight\PYZus{}d\PYZus{}2} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{random\PYZus{}uniform}\PY{p}{(}\PY{p}{[}\PY{n}{hidden\PYZus{}layer\PYZus{}size\PYZus{}d}\PY{p}{,} 
                \PY{n}{hidden\PYZus{}layer\PYZus{}size\PYZus{}d}\PY{p}{]}\PY{p}{,} \PY{n}{minval}\PY{o}{=}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{maxval}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{float32}\PY{p}{)}\PY{p}{)}
