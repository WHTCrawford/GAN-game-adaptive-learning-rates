...
weight_d_2 = tf.Variable(tf.random_uniform([hidden_layer_size_d, 1], minval=-1, maxval=1, dtype=tf.float32))
bias_d_2 = tf.Variable(tf.random_uniform([1], minval=-1, maxval=1, dtype=tf.float32))
...
data_directory = '/Users/Billy/PycharmProjects/GALR/data_uneven/gd'
